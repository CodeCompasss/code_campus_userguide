...
!!! note
    These platforms are primarily web-based and do not require local installation.
    They are accessible via any modern web browser included in CodeCampus OS.

*   **CodeCombat:** [codecombat.com](https://codecombat.com/)
*   **CSS Grid Garden:** [cssgridgarden.com](https://cssgridgarden.com/)
*   **SQL Noir:** [sqlnoir.com](https://sqlnoir.com/)
