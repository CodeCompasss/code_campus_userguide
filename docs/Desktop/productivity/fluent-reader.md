...
!!! note
    CodeCampus OS includes Fluent Reader by default.
...
=== "AppImage"
    Download the latest `.AppImage` from the [official repository](https://github.com/yang991178/fluent-reader/releases), make it executable, and run it.
